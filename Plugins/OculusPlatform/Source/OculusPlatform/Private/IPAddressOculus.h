...
*/
class OCULUSPLATFORM_API FInternetAddrOculus : public FInternetAddr
{
public:
	ovrID OculusId;
	 ...
	 * Constructor
	 */
	explicit FInternetAddrOculus(FString InString) :
	...
	{
		return FNetworkProtocolTypes::OculusPlatform;
	}
