...
*/
class FPhotonOvrInternetAddr : public FInternetAddr
{
public:
	ovrID OculusId;
	 ...
	 * Copy Constructor
	 */
	FPhotonOvrInternetAddr(const FPhotonOvrInternetAddr& Src)
	 ...
	 * Constructor
	 */
	explicit FPhotonOvrInternetAddr(ovrID InOculusId)
		: OculusId(InOculusId)
	{
	}
	 ...
	 * Constructor
	 */
	explicit FPhotonOvrInternetAddr(FString InString)
	 ...
	 * Constructor
	 */
	explicit FPhotonOvrInternetAddr(const FURL& ConnectURL)
	{
	...
	{
		FPhotonOvrInternetAddr& OculusOther = (FPhotonOvrInternetAddr&)Other;
		return OculusId == OculusOther.OculusId;
	}

	bool operator!=(const FPhotonOvrInternetAddr& Other) const
	{
		return !(FPhotonOvrInternetAddr::operator==(Other));
	}
	...
	{
		TSharedRef<FPhotonOvrInternetAddr> NewAddress = MakeShareable(new FPhotonOvrInternetAddr);
