...
void UOvrNetConnection::InitBase(UNetDriver* InDriver, class FSocket* InSocket, const FURL& InURL, EConnectionState InState, int32 InMaxPacket, int32 InPacketOverhead)
{
	if (bIsPassThrough)
	{
...
void UOvrNetConnection::InitLocalConnection(UNetDriver* InDriver, class FSocket* InSocket, const FURL& InURL, EConnectionState InState, int32 InMaxPacket, int32 InPacketOverhead)
{
...
void UOvrNetConnection::InitRemoteConnection(UNetDriver* InDriver, class FSocket* InSocket, const FURL& InURL, const class FInternetAddr& InRemoteAddr, EConnectionState InState, int32 InMaxPacket, int32 InPacketOverhead)
{
	if (InDriver->GetSocketSubsystem() != nullptr)
	{
		bIsPassThrough = true;
...
void UOvrNetConnection::LowLevelSend(void* Data, int32 CountBits, FOutPacketTraits& Traits)
{
	if (bIsPassThrough)
	{
...
FString UOvrNetConnection::LowLevelGetRemoteAddress(bool bAppendPort)
{
	if (bIsPassThrough)
	{
...
FString UOvrNetConnection::LowLevelDescribe()
{
	if (bIsPassThrough)
	{
...
void UOvrNetConnection::FinishDestroy()
{
	if (bIsPassThrough)
	{
...
FString UOvrNetConnection::RemoteAddressToString()
{
	if (bIsPassThrough)
	{
