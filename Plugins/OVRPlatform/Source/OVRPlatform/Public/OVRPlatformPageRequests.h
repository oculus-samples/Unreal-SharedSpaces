...
public:
    ...
    /**
     * Fetches a page from an FOvrCloudStorageMetadataPages paged array.
     * @param CloudStorageMetadataPages - a FOvrCloudStorageMetadataPages
     * @param CloudStorageMetadataArray - an array of FOvrCloudStorageMetadata
     * @param bHasNextPage - if more pages are available after this one.
     */
    UFUNCTION(BlueprintCallable, meta = (Latent, LatentInfo = "LatentInfo", WorldContext = "WorldContextObject", ExpandEnumAsExecs = "InExecs,OutExecs", AutoCreateRefTerm="CloudStorageMetadataPages"), Category = "OvrPlatform|Models|CloudStorageMetadataArray")
    static void FetchCloudStorageMetadataPage(
        UObject* WorldContextObject,
        const EOvrForwardArrayIteratorInputPins& InExecs,
        EOvrPageRequestOutputPins& OutExecs,
        FLatentActionInfo LatentInfo,
    ...
    /**
     * Fetches a page from an FOvrRoomPages paged array.
     * @param RoomPages - a FOvrRoomPages
     * @param RoomArray - an array of FOvrRoom
     * @param bHasNextPage - if more pages are available after this one.
     */
    UFUNCTION(BlueprintCallable, meta = (Latent, LatentInfo = "LatentInfo", WorldContext = "WorldContextObject", ExpandEnumAsExecs = "InExecs,OutExecs", AutoCreateRefTerm="RoomPages"), Category = "OvrPlatform|Models|RoomArray")
    static void FetchRoomPage(
        UObject* WorldContextObject,
        const EOvrForwardArrayIteratorInputPins& InExecs,
        EOvrPageRequestOutputPins& OutExecs,
        FLatentActionInfo LatentInfo,
    ...
    /**
     * Fetches a page from an FOvrRoomInviteNotificationPages paged array.
     * @param RoomInviteNotificationPages - a FOvrRoomInviteNotificationPages
     * @param RoomInviteNotificationArray - an array of FOvrRoomInviteNotification
     * @param bHasNextPage - if more pages are available after this one.
     */
    UFUNCTION(BlueprintCallable, meta = (Latent, LatentInfo = "LatentInfo", WorldContext = "WorldContextObject", ExpandEnumAsExecs = "InExecs,OutExecs", AutoCreateRefTerm="RoomInviteNotificationPages"), Category = "OvrPlatform|Models|RoomInviteNotificationArray")
    static void FetchRoomInviteNotificationPage(
        UObject* WorldContextObject,
        const EOvrForwardArrayIteratorInputPins& InExecs,
        EOvrPageRequestOutputPins& OutExecs,
        FLatentActionInfo LatentInfo,
    ...
    /**
     * Fetches a page from an FOvrUserAndRoomPages paged array.
     * @param UserAndRoomPages - a FOvrUserAndRoomPages
     * @param UserAndRoomArray - an array of FOvrUserAndRoom
     * @param bHasNextPage - if more pages are available after this one.
     */
    UFUNCTION(BlueprintCallable, meta = (Latent, LatentInfo = "LatentInfo", WorldContext = "WorldContextObject", ExpandEnumAsExecs = "InExecs,OutExecs", AutoCreateRefTerm="UserAndRoomPages"), Category = "OvrPlatform|Models|UserAndRoomArray")
    static void FetchUserAndRoomPage(
        UObject* WorldContextObject,
        const EOvrForwardArrayIteratorInputPins& InExecs,
        EOvrPageRequestOutputPins& OutExecs,
        FLatentActionInfo LatentInfo,
